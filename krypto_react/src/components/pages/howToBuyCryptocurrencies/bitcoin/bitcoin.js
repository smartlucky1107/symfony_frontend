...
const HowToBuyBitcoinPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{i18next.t("HOWTOBUYBITCOIN_PAGE_TITLE")}</title>
                <meta
                    name="description"
                    content={i18next.t("HOWTOBUYBITCOIN_PAGE_DESC")}
                />
                <link
                    rel="canonical"
                    href={
            ...
            <Header />
            <div className={"container subPage howToBuy howToBuyBitcoinPage"}>
                <h1>{i18next.t("Jak kupić Bitcoina?")}</h1>
                {i18next.t(
                ...
                <div className="row rowBox whatDoINeed">
                    <div className="col col-xl-6 alignCenter">
                        <div>
                            <h3>
                                {i18next.t(
                                    "Czego potrzebuję do zakupu Bitcoina?"
                                )}
                            </h3>
                            ...
                            <div className="sticky">
                                ...
                                <ul className="customList numberList">
                                    ...
                                    >
                                        <span>2</span>
                                        {i18next.t(
                                            " W polu “Zapłacę” wpisz kwotę, którą chcesz przeznaczyć na zakup kryptowaluty. Automat wyświetli ilość wymienianych Bitcoinów. "
                                        )}
                                    </li>
                                    <li
                                        onClick={() =>
                ...
                <div className="row rowBox offsetTop">
                    <div className="col col-xl-6 alignCenter textCenter">
                        <div>
                            <h3>
                                {i18next.t(
                                    "Gratulacje! Właśnie dokonałeś swojego pierwszego zakupu Bitcoina. Nie było to takie trudne, prawda?"
                                )}
                            </h3>
                            <p>
                                {i18next.t(
                ...
                <div className="row rowBox offsetTop">
                    ...
                    <div className="col col-xl-6 alignCenter textCenter">
                        <h3>
                            {i18next.t(
                                "Transakcja zostanie przetworzona przez zautomatyzowany system, dlatego Bitcoin znajdzie się błyskawicznie na Twoim portfelu. "
                            )}
                        </h3>
                    </div>
                </div>
...
export default HowToBuyBitcoinPage;
